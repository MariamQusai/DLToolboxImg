...
[Modified UNet with Dropout=0.6, train only on positive data, cosine annealing lr schedule, bs=34](https://github.com/x110/DLToolboxImg/blob/master/NoduleSegmentationModel15.ipynb)|  |  Horizantal + vertical flips + random rotations [-20,20] + elastic distortion(alpha =34, sigma=3 )+ resize(.8,1.15)|  dice loss| [-.6](https://github.com/x110/DLToolboxImg/blob/master/models/model16.ipynb)
<!--
